...
template<class TTreeTraits, class TAllocator = cube::allocator>
...
public:
  ...
  void swap(rb_tree_base& other)
  {
    if (&other != this) {
      ...
      cube::swap(m_root, other.m_root);
      cube::swap(m_size, other.m_size);
      validate();
    }
  }
...
template<typename TKey, class TAllocator = cube::allocator>
